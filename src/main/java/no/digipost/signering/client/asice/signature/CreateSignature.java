...
public class CreateSignature {
    ...
    public Signature createSignature(final List<ASiCEAttachable> attachedFiles, final KeyStoreConfig keyStoreConfig) {
        ...
        Document document = createXAdESProperties.createPropertiesToSign(attachedFiles, keyStoreConfig.getSertifikat());
        ...
        try {
            ...
            throw new XmlValideringException("Kunne ikke validere generert signatures.xml. Sjekk at input er gyldig og at det ikke er ugyldige tegn i filnavn o.l.", e);
        } catch (IOException e) {
